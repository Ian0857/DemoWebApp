...
namespace ASPNETCoreWebApi6.Models
{
    ...
    public interface IContosouniversityContextProceduresContract
    {
        Task<int> Department_DeleteAsync(int? DepartmentID, byte[] RowVersion_Original, CancellationToken cancellationToken = default);
        Task<List<Department_InsertResult>> Department_InsertAsync(string Name, decimal? Budget, DateTime? StartDate, int? InstructorID, CancellationToken cancellationToken = default);
        Task<List<Department_UpdateResult>> Department_UpdateAsync(int? DepartmentID, string Name, decimal? Budget, DateTime? StartDate, int? InstructorID, byte[] RowVersion_Original, CancellationToken cancellationToken = default);
    }
